...
export function validateLead(data) {
  ...
  return {value:{name:data.name.trim(),email:data.email.trim().toLowerCase(),phone,country:data.country,role:data.role,experience:data.experience,income:data.income,consentVersion:'contact-2026-09-17'}};
}
